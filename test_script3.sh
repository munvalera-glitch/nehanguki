...
# Inject a middleware to fake authentication with a REAL user id
...
rm server_test.js dummy.jpg res.json res2.json test_std.pdf test_pwd.pdf test_script3.sh
echo "Done."
